...
class Login extends Controller {
    ...
    public function index() {
        ...
        // 验证登录结果
        if(empty($user_info))
            return json(array('code'=>0,'msg'=>$User->error_info['login']));
        // 设置cookie信息
        $this->cookie(array(
    ...
    public function bind() {
        ...
        if($sign!==$server_sign)
            return json(array('code'=>0,'msg'=>'签名不合法'));
        // 实例化模型
        $User=new User();
        // 注册
